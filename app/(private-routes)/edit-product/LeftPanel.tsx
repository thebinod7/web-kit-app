...
export default function LeftPanel() {
    return (
        <div className="rounded-lg bg-white p-6 shadow-sm md:col-span-1">
            ...
            <button className="mt-6 cursor-pointer w-full rounded-md bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2">
                Update Details
            </button>
